...
-}
module Ri.CodePointPredicates.Rfc3987
where

import Ri.Prelude hiding ((|||), (&&&), inRange, Predicate)
import Ri.CodePointPredicates.Core
import qualified Ri.CodePointPredicates.Rfc3986 as A
